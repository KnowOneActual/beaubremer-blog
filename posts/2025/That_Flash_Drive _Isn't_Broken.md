...
Have you ever loaded a USB drive with music or movies, only to see a total mess when you plug it into a TV or car
stereo? Your files are mixed with strange, unplayable ghost files starting with `._` or named `.DS_Store`.
